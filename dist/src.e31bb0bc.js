...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/wipe.css/wipe.css":[function(require,module,exports) {
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"wipe.css":"../node_modules/wipe.css/wipe.css","./assets/images/fond-black.svg":[["fond-black.4638b63d.svg","assets/images/fond-black.svg"],"assets/images/fond-black.svg"],"./assets/images/loader-arrow-start.svg":[["loader-arrow-start.71eb51e0.svg","assets/images/loader-arrow-start.svg"],"assets/images/loader-arrow-start.svg"],"./assets/images/scratch-cursor.gif":[["scratch-cursor.8c69a8c3.gif","assets/images/scratch-cursor.gif"],"assets/images/scratch-cursor.gif"],"./assets/videos/shatter.png":[["shatter.33968e12.png","assets/videos/shatter.png"],"assets/videos/shatter.png"],"./assets/images/fond.jpg":[["fond.cce03e29.jpg","assets/images/fond.jpg"],"assets/images/fond.jpg"],"./assets/videos/artemis/anim-artemis.png":[["anim-artemis.f2a393fd.png","assets/videos/artemis/anim-artemis.png"],"assets/videos/artemis/anim-artemis.png"],"./assets/images/glows/artemis-arc.png":[["artemis-arc.de16d4bc.png","assets/images/glows/artemis-arc.png"],"assets/images/glows/artemis-arc.png"],"./assets/videos/biche/anim-biche-verticale.png":[["anim-biche-verticale.c1c87a62.png","assets/videos/biche/anim-biche-verticale.png"],"assets/videos/biche/anim-biche-verticale.png"],"./assets/images/glows/artemis-biche.png":[["artemis-biche.8f23c29a.png","assets/images/glows/artemis-biche.png"],"assets/images/glows/artemis-biche.png"],"./assets/videos/fleurs/anim-fleur-verticale.png":[["anim-fleur-verticale.a43b071b.png","assets/videos/fleurs/anim-fleur-verticale.png"],"assets/videos/fleurs/anim-fleur-verticale.png"],"./assets/images/glows/flower-left.png":[["flower-left.411e8434.png","assets/images/glows/flower-left.png"],"assets/images/glows/flower-left.png"],"./assets/videos/fleurs-2/anim-fleurs-2-verticale.png":[["anim-fleurs-2-verticale.a703ed47.png","assets/videos/fleurs-2/anim-fleurs-2-verticale.png"],"assets/videos/fleurs-2/anim-fleurs-2-verticale.png"],"./assets/images/glows/flower-middle.png":[["flower-middle.72f41c7d.png","assets/images/glows/flower-middle.png"],"assets/images/glows/flower-middle.png"],"./assets/videos/fleurs-3/anim-fleurs-3-verticale.png":[["anim-fleurs-3-verticale.cbe2c46e.png","assets/videos/fleurs-3/anim-fleurs-3-verticale.png"],"assets/videos/fleurs-3/anim-fleurs-3-verticale.png"],"./assets/images/glows/flower-right.png":[["flower-right.40574b03.png","assets/images/glows/flower-right.png"],"assets/images/glows/flower-right.png"],"./assets/videos/femme-bebe/anim-femme-bebe-vertical.png":[["anim-femme-bebe-vertical.59326ebd.png","assets/videos/femme-bebe/anim-femme-bebe-vertical.png"],"assets/videos/femme-bebe/anim-femme-bebe-vertical.png"],"./assets/images/glows/women.png":[["women.3b39adcc.png","assets/images/glows/women.png"],"assets/images/glows/women.png"],"./assets/videos/artemis-arc/anim-artemis-arc-vertical.png":[["anim-artemis-arc-vertical.c1786778.png","assets/videos/artemis-arc/anim-artemis-arc-vertical.png"],"assets/videos/artemis-arc/anim-artemis-arc-vertical.png"],"./assets/images/glows/artemis-badass.png":[["artemis-badass.93401f77.png","assets/images/glows/artemis-badass.png"],"assets/images/glows/artemis-badass.png"],"./assets/images/texture.jpg":[["texture.5666db08.jpg","assets/images/texture.jpg"],"assets/images/texture.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function Scroller(scrollingElement, appDebugger) {
    var debug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    var velocity = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : VELOCITY.prod;
    ...
    this.hammertime = new _hammerjs.default(window);
  ...
  _createClass(Scroller, [{
    ...
    value: function init() {
      ...
      if ('ontouchstart' in document.documentElement) {
        hammertime.get('pan').set({
          direction: _hammerjs.default.DIRECTION_HORIZONTAL,
          threshold: 0
        });
        ...
        hammertime.on('panleft panright swipeleft swiperight', function (e) {
    ...
    value: function handler(e) {
      var isTouchEvents = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      e = isTouchEvents ? e : window.event || e;
      e.preventDefault(); // block scroll left/right on Desktop

      if (Math.abs(e.wheelDeltaX) > Math.abs(e.wheelDeltaY)) this.config.doScroll = false;else this.config.doScroll = true; // I don't know why I wrote this but apparently do not remove it...
      ...
      _gsap.gsap.killTweensOf(this.app);

      this.clearAuto();
      this.scroll(_objectSpread({
        wheelDelta: isTouchEvents ? e.deltaX : e.wheelDelta || -e.detail
      }, isTouchEvents ? {
        isTouchEvents: isTouchEvents,
    ...
    value: function scroll() {
      ...
      var app = this.app,
          ...
          config = this.config;
      var wheelDelta = conf.wheelDelta,
          scrollTo = conf.scrollTo,
          duration = conf.duration,
          cb = conf.cb,
          isTouchEvents = conf.isTouchEvents,
          direction = conf.direction; // scroll converter
      // -1 = RIGHT, 1 = LEFT, 0 when !wheeldelta

      var delta = config.auto ? -1 : !wheelDelta ? 0 : Math.max(-1, Math.min(1, wheelDelta));
      var tDelta = direction === 'RIGHT' ? -1 : direction === 'LEFT' ? 1 : undefined;

      var scrollLeft_ = _gsap.gsap.getProperty(app, 'scrollLeft'); // Normal behaviour


      if (!scrollTo) {
        _gsap.gsap.to(app, {
          scrollLeft: scrollLeft_ - (isTouchEvents ? tDelta : delta) * config.velocity * (isTouchEvents ? 2 : 1),
          ease: 'power2.out'
        }); // Auto Scroll to a specific position

      } else if (scrollTo && config.auto) {
        _gsap.gsap.to(app, _objectSpread({
          scrollLeft: scrollTo
        }, duration ? {
          duration: duration
        } : {}, {
      ...
      var scrollDirection = isTouchEvents ? direction : config.auto ? app.scrollLeft <= scrollTo ? 'RIGHT' : 'LEFT' : delta < 0 ? 'RIGHT' : 'LEFT';
      ...
      if (config.debug) this.log(); // Callback any functions passed as params

      config.animationsOnScroll.forEach(function (tween) {
        return tween();
      });
    }
  }, {
    ...
    key: "auto",
    value: function auto() {
      var scrollTo = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    ...
    value: function toggleAuto() {
      ...
      if (this.config.auto) this.auto();else this.clearAuto();
    }
  }, {
    key: "addAnimation",
    value: function addAnimation(tween) {
      this.config.animationsOnScroll = [].concat(_toConsumableArray(this.config.animationsOnScroll), [tween]);
    }
  }, {
    key: "setDoScroll",
    value: function setDoScroll(value) {
      this.config.doScroll = value;
      if (this.config.doScroll) this.init();else this.release();
    }
  }]);
...
},{"gsap":"../node_modules/gsap/index.js","hammerjs":"../node_modules/hammerjs/hammer.js"}]